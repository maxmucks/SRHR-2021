package com.maxmux.srhr.config;

public class AppConfig {

    //your server key and rest api key which obtained from the admin panel
    public static final String SERVER_KEY = "WVVoU01HTklUVFpNZVRsNlkyMW9lVXh0TVdobFJ6RXhaVWhPZG1KSVZqQmhWemwxWTNrMWFtSXlNSFpZTWtaM1kwZDRjRmt5UmpCaFZ6bDFVMWRTWmxreU9YUk1iVEZvWlVjeE1XVkROWHBqYldoNQ==";
